...
Streamlit + OpenAI Function Calling + 6가지 Tool
[변경] tool_facilities 연결 + 렌트카/편의시설 지도링크 카드 렌더링
"""
...
단, 날씨·맛집·관광지·교통·렌트카·편의시설 등 일정 외 단순 질문은 즉시 해당 tool을 사용해 답변하세요.
...
- 편의점·마트·병원·약국·주유소·은행·숙박 등 편의시설 질문 → search_facilities
